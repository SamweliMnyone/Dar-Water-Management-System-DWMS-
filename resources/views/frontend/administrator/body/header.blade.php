    ...
    <li class="nav-item dropdown">
             ...
             <!-- Badlisha  link to routes kwa ajili ya admin profiles -->
                  <li class="dropdown-item py-2">
                    <a href="{{ route('AdministratorProfile') }}" class="text-body ms-0">
                  ...
                  <li class="dropdown-item py-2">
                    <a href="{{ route('PasswordUpdate') }}" class="text-body ms-0">
                  ...
                  <li class="dropdown-item py-2">
                    ...
                    <a href="{{ route('administrator.logout') }}" class="text-body ms-0">
