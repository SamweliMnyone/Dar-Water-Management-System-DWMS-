    ...
    <tr>
        ...
        <td>
            ...
            <form action="{{ route('tech_delete', $users->id) }}" method="POST" style="display:inline;">
                @csrf
                @method('DELETE')
                <a href="#" onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this Administrator?')) { this.closest('form').submit(); }">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editUserModalLabel">Edit Administrator Details</h5>
