...
<div class="page-content">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Administrator View</h6>
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                          ...
                          <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalToggleLabel">Add Administratorf</h1>
                          ...
                          <div class="modal-body">
                            ...
                            <form class="forms-sample" method="post" action="{{ route('add_admin')}}">
                              @csrf
